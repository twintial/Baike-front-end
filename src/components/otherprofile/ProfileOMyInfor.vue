<template>
    <div>
        ...
        <profile-header @func="getMsgFormHead"></profile-header>
         <div class="row">
...
<script>
import profileHeader from '@/components/otherprofile/common/ProfileOHeader.vue'
import leftSideBar from '@/components/otherprofile/common/OLeftSideBar.vue'
