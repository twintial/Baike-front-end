      ...
      <div id="full-slider-wrapper">
        <div id="layerslider" style="width:100%;height:500px;">
          <div class="ls-slide" data-ls="transition2d:1;timeshift:-1000;">
            <img
              src="images/sliderimages/bg.png"
              class="ls-bg"
            ...
            <h3
              ...
              data-ls="offsetxin:0;durationin:2500;delayin:500;durationout:750;easingin:easeOutElastic;rotatexin:90;transformoriginin:50% bottom 0;offsetxout:0;rotateout:-90;transformoriginout:left bottom 0;"
            >
              World’s Biggest
            </h3>
            <h1
              ...
              data-ls="offsetxin:left;durationin:3000; delayin:800;durationout:850;rotatexin:90;rotatexout:-90;"
            >
              Powerfull Video Theme
            </h1>
            <p
              class="ls-l"
              style="font-weight:600;left:62px; top:250px; opacity: 1;width: 450px; color: #444; font-size: 14px; font-family: 'Open Sans';"
              data-ls="offsetyin:top;durationin:4000;rotateyin:90;rotateyout:-90;durationout:1050;"
            >
            ...
            <a
              ...
              data-ls="durationout:850;offsetxin:90;offsetxout:-90;duration:4200;fadein:true;fadeout:true;"
              >Buy This Theme</a
            >
            <img
              class="ls-l"
              src="images/sliderimages/layer1.png"
              alt="layer 1"
              style="top:55px; left:700px;"
            ...
            <img
              ...
              src="images/sliderimages/left.png"
              alt=""
            />
            <img
              class="ls-l ls-linkto-2"
              ...
              src="images/sliderimages/right.png"
              alt=""
            />
          </div>
          <div class="ls-slide" data-ls="transition2d:1;timeshift:-1000;">
            <img
              src="images/sliderimages/bg2.png"
              class="ls-bg"
              alt="Slide background"
            />
            <h3
      ...
      <div class="row secBg">
        <div class="large-12 columns">
          ...
          >
            ...
            v-for="(result, index) in video1"
                  :key="index + '-label'">
              <figure class="premium-img">
                <img src="http://placehold.it/185x130" alt="carousel" />
                <a href="categories.html" class="hover-posts">
                  <span><i i class="fa fa-play">Watch Video</i></span>
                </a>
              </figure>
              <h6><a>{{result.videoName}}</a></h6>
            </div>
          </div>
          <!-- end carousel -->
        </div>
  ...
  methods: {
    ...
    categary(x) {
      this.$axios
        .get("/category/" + x)
        .then(successResponse => {
          if (x == 1) this.video1 = successResponse.data;
          if (x == 2) this.video2 = successResponse.data;
          if (x == 3) this.video3 = successResponse.data;
          if (x == 4) this.video4 = successResponse.data;
        })
        .catch(failResponse => {});
    }
  }
