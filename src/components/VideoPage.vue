                            ...
                            <div class="media-object-section">
                                <div class="author-img-sec">
                                    <div class="thumbnail author-single-post">
                                        <a @click="goToDetails(uploadUserInfo.uid)"><img :src="uploadUserInfo.iconURL?url + '/img/userIcon/'+uploadUserInfo.iconURL:defaultIcon" alt="post"></a>
                                    </div>
                            ...
                            <div v-for="(video, index) in relatedVideos" :key="index" class="item large-4 columns end group-item-grid-default">
                                <div class="post thumb-border">
                                    <div class="post-thumb">
                                        <img :src="url + '/img/videoCover/'+video.interVideoID+'/'+video.icon" alt="landing">
                    ...
                    <div class="large-12 columns">
                            ...
                            <div class="media-object stack-for-small">
                                <div class="media-object-section comment-img text-center">
                                    <div class="comment-box-img">
                                        <img :src="loginUserInfo.uID ? url + '/img/userIcon/'+loginUserInfo.iconURL : defaultIcon" alt="comment">
                                    </div>
                        ...
                        <div class="main-comment showmore_one">
                            <div v-for="(comment, index) in comments" :key="index" class="media-object stack-for-small comment-buttom-line">
                                <div class="media-object-section comment-img text-center">
                                    <div class="comment-box-img">
                                        <img :src="url + '/img/userIcon/'+comment.icon" alt="comment">
                                    </div>
                                </div>
                            ...
                            <div class="widgetContent">
                                <div v-for="(video, index) in mostViewVideos" :key="index" class="video-box thumb-border">
                                    <div class="video-img-thumb">
                                        <img :src="url + '/img/videoCover/'+video.interVideoID+'/'+video.icon" alt="most viewed videos">
                                        <a @click="goToVideoPage(video.interVideoID)" class="hover-posts">
                                            <span><i class="fa fa-play"></i>Watch Video</span>
                                        </a>
                                    </div>
...
export default {
  ...
  data () {
    return {
      url: url,
      defaultIcon: url + '/img/userIcon/user_default.jpg',
      isEnded: false,
      interVideoID: null,
      // 用户信息
      uploadUserInfo:{
