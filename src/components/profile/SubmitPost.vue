                                          ...
                                          <div class="large-12 columns">
                                            <div>
                                              ...
                                              <label for="videoCover"> 
                                                <img id="cover-preview" :src="coverFiles.length ? url : resourceUrl + '/img/cover_default.jpg'"/>
                                              </label>
                                            </div>
                                            <div v-show="false">
                                              <file-upload
                                                ...
                                                name="videoCover"
                                                :post-action="resourceUrl + '/api/cover/upload'"
                                                :drop="false"
                                                v-model="coverFiles"
...
export default {
  ...
  data() {
    return {
      ...
      thread: 3,
      name: 'file',
      postAction: resourceUrl + '/api/video/upload',
      uploadAuto: true,
      currentIndex: -1,
      // 视频封面上传
      coverFiles: [],
